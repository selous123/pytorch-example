...
class dcgan_generator(nn.Module):
    def __init__(self):
        ...
        self.deconv2 = nn.ConvTranspose2d(128,64,5,2,2,bias=False);
        self.bn2 = nn.BatchNorm2d(64)
        #output_shape[N,32,28,28]
        self.deconv3 = nn.ConvTranspose2d(64,1,5,2,2,bias=False);
    ...
    def forward(self,x):
        ...
        x = self.deconv3(x,output_size=[conf.batch_size,64,28,28]);
        x = F.tanh(x);
        return x;
...
class dcgan_discriminator(nn.Module):
    def __init__(self):
        ...
        #input x data[-1,1,28,28,]
        #with shape [N,C_in,H,W];
        self.conv1 = nn.Conv2d(1,32,5,stride=2,padding=2,bias=False);
        self.bn1 = nn.BatchNorm2d(32);
        #self.pool = nn.MaxPool2d(2,stride=2);
        self.conv2 = nn.Conv2d(32,64,5,stride=2,padding=2,bias=False);
        self.bn2 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64,128,4,stride=2,padding=2,bias=False)
